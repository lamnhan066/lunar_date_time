...
class Utc7 {
  ...
  static tz.Location? _utc7Location;
  ...
  /// Convert a TZDateTime to UTC+7 timezone as TZDateTime
  /// If the TZDateTime is already in UTC+7, returns it as-is
  /// This always uses UTC+7 regardless of device timezone
  static tz.TZDateTime toUtc7(tz.TZDateTime dateTime) {
    _initializeTimezoneSync();
    if (dateTime.location == _utc7Location) {
      return dateTime;
    }
