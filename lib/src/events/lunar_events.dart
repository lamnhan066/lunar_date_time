...
final getLunarEvents = LunarEventList(events: {
  ...
  LunarDateTime(0, 1, 9): [
    LunarEvent(
      date: LunarDateTime(0, 1, 9),
      title: 'Ngày Vía Ngọc Hoàng',
      description:
          'Ngày thờ Ngọc Hoàng Thượng Đế, cầu tài lộc, sức khỏe và may mắn.',
      repeat: LunarRepeat.yearly(),
      mode: EventMode.readonly,
    ),
  ],
  ...
  LunarDateTime(0, 6, 19): [
    LunarEvent(
      date: LunarDateTime(0, 6, 19),
      title: 'Ngày Vía Quan Âm Thành Đạo',
      description:
          'Ngày vía Quan Âm Bồ Tát, cầu an lành và bình yên cho gia đình.',
      repeat: LunarRepeat.yearly(),
      mode: EventMode.readonly,
    ),
  ],
  ...
  LunarDateTime(0, 9, 19): [
    LunarEvent(
      date: LunarDateTime(0, 9, 19),
      title: 'Ngày Vía Quan Âm Xuất Gia',
      description:
          'Ngày vía Quan Âm Bồ Tát, thể hiện lòng thành kính và cầu bình an.',
      repeat: LunarRepeat.yearly(),
      mode: EventMode.readonly,
